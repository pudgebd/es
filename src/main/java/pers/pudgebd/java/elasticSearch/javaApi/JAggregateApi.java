...
import pers.pudgebd.java.elasticSearch.basic.JAggregateBasicApi;
import pers.pudgebd.java.utils.constants.EsCnts;
import pers.pudgebd.java.utils.constants.PropName;

import java.net.InetAddress;

public class JAggregateApi extends JAggregateBasicApi {
...
//        usingAggregations(client);
//        searchTemplate(client);
//        structuringAggregations(client);
